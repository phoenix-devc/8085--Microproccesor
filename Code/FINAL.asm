...
START:	.ORG 0000H
	...
	; INITIALISING THE OUTPUT LED PORTS
	MVI A,80H
	OUT 03H
	MVI A,80H
	OUT 03H
	; INITIALISING THE OUTPUT KEYPAD AND LCD PORTS
	MVI A,88H
	OUT 83H
	OUT 83H
	; LCD INITIALISER
	...
	CALL CMD
	; DISPLAYING THE FIRST DATA SEQUENCE
...
P_OPT:	MVI A,01H; /LCD clear command
	...
	CPI 0AH
	CZ CODE
	MOV A,B; RETREIVE VALUE IF CHANGED
	CPI 0BH
	CZ CODE
	JMP P_OPT
	
CODE:	LXI H,BOARD   ;CWIN LOADS BOARD AUTOMATICALLY /H-L MODIFIED NO STACKING FOR H/
	CALL UPDATE
	MVI B,09H
	CPI 0AH
	JZ PLAY1
